...
1. Clone o código fonte
   ...
   ```bash
    git clone git@github.com:wellingtonrsdev/desafio-rotas-react.git
   ```

2. Abra o projeto em sua IDE de preferência(utilizado o Visual Studio Code).

3. Faça o download das dependências com o comando a seguir: (certifique que esteja na pasta raiz)  
 ```bash 
  yarn
 ```
